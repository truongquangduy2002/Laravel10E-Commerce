...
class BrandController extends Controller
{
    ...
    public function UpdateBrand(Request $request)
    {
        ...
        if ($request->hasFile('brand_image')) {
            ...
            // $newImagePath = $newImage->storeAs('upload/brands', $newImageName, 'public');
            // $save_url = 'upload/brands/' . $newImageName;
            ...
            // Cập nhật đường dẫn hình ảnh mới trong database
            // $brand_id->brand_image = $newImagePath;
            ...
            //     $updateData['brand_image'] = $newImagePath;
            // }
